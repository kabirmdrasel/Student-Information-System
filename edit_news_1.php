...
<h2 id=title>Edit News & Events/ Extra/Co-curricular Activity /Seminar</h2>
    <div id="maincol_container4">
      <div class="maincol_middle">
		...
		$sql=mysql_query("select * from bac.news where id='$eid'");
    ...
    <table width="500" border="1">
       ...
       <tr>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Serial No.</td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Description</td>
...
<td align="center" style="background-color: #1D5174;"><font color="white"><strong>Type</td>		
       ...
       <tr>
        <td>
        <input type="text" name="id" id="id" size="4" value="<?php echo $user['id'];?>"/>
        </td>
        <td><input type="text" name="description" id="description" size="55" value="<?php echo $user['description'];?>"/></td>
        <td><input type="text" name="date" id="date"  size="15" value="<?php echo $user['date'];?>"/></td>
		<td><input type="text" name="type" id="type"  size="15" value="<?php echo $user['type'];?>"/></td>
       </tr>   
<tr>
<td></td>
...
<table>
    <tr>
       ...
       <td>
       <input class="btn" name="action" id="action" type="submit"  value="Save The Change"> 
       </td>
    </tr> 

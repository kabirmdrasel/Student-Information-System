...
if($_GET['did']){mysql_query("delete from class where id='$_GET[did]'"); }
?>
...
function deluser(did)
{
	...
	if(msg)
	{window.location="edit_class.php?did="+did;}
...
<h2 id=title>Edit Class Routine</h2>     
    <div id="maincol_container">
      <div class="maincol_middle">
        <div class="maincol1">         
<form action="edit_class.php" method="post" onSubmit="return validate(this)">
  ...
  <div align="center">
    ...
    <tr>          
	   ...
	   <td>
		...
		echo "<td>".$user['k']."</td>";
		echo "<td>".$user['l']."</td>";
		echo "<td><a href=\"edit_class_1.php?eid=".$user['id']."\">Edit</a></td>";

...
if($_GET['did']){mysql_query("delete from exam_info where id='$_GET[did]'"); }
?>
...
function deluser(did)
{
	...
	if(msg)
	{window.location="edit_exam_info.php?did="+did;}
...
<h2 id=title>Search Exam Info</h2>     
    <div id="maincol_container4">
      <div class="maincol_middle">
        <div class="maincol1">         
<form action="edit_exam_info.php" method="post" onSubmit="return validate(this)">
  ...
  <div align="center">
    ...
    <tr>
       <td width="380"></td>	
	   <td>
          <input class="btn" name="action" id="action" type="submit"  value="       Search Exam Info       ">
       </td>
	</tr>
	</table>
  </div>
		...
		echo "<td><a href=\"edit_exam_info_1.php?eid=".$user['id']."\">Edit</a></td>";

...
if($_GET['did']){mysql_query("delete from bac.contact where id='$_GET[did]'"); }
?>
...
function delmessage(did)
{
	var msg=confirm("Are you sure you want to delete this message?");
	if(msg)
	{window.location="view_message.php?did="+did;}
  ...
  <div id="main">
    ...
    <div id="maincol_container4">
      <div class="maincol_middle">
		...
		$sql=mysql_query("select * from bac.contact") or die(mysql_error());		

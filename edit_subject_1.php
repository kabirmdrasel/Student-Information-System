...
<h2 id=title>Edit Subject</h2>
    <div id="maincol_container4">
      <div class="maincol_middle">
		...
		$sql=mysql_query("select * from bac.subject where id='$eid'");
    ...
    <table width="100" border="1">
       ...
       <tr>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Theory</td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Credit</td>
	    <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Lab</td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Credit</td>
		<td align="center" style="background-color: #1D5174;"><font color="white"><strong>semester</td>		
        </tr>
       <tr>
        <td>
        <input type="text" name="theory" id="theory" size="30"value="<?php echo $user['theory'];?>"/>
        </td>
        <td><input type="text" name="credit_1" id="credit_1" size="8"value="<?php echo $user['credit_1'];?>"/></td>
        <td><input type="text" name="lab" id="lab" size="30"value="<?php echo $user['lab'];?>"/></td>
		<td><input type="text" name="credit_2" id="credit_2" size="8"value="<?php echo $user['credit_2'];?>"/></td>
		<td><input type="text" name="semester" id="semester" size="10"value="<?php echo $user['semester'];?>"/></td>
       </tr>   
<tr>
<td></td>
...
<table>
    <tr>
       ...
       <td>
       <input class="btn" name="action" id="action" type="submit"  value="      Save Subject     "> 
       </td>
    </tr> 

...
function validate(form) {
 ...
 if(name == "") {
  ...
  if(student_id == "") {
    ...
    if(username == "") {
    inlineMsg('username','You Must Enter An Username!',2);
    return false;
  }
  ...
  if(password.length <= 5) {
    inlineMsg('password','Password Must Contain At Least Six Characters!',3);
    return false;
  }
  re = /[0-9]/; 
  if(!re.test(password)) {
	inlineMsg('password','Password Must Contain At Least One Number!',3);
    return false;
  } 
  if(c_password == "") {

    ...
    <div id="leftcol_container">
      ...
      <div class="leftcol_bottom">
        <p>&nbsp;</p>
           ...
           <h2 id=title>Submit Teacher/Other Staff</h2>     
...
<form action="action.php" method="post" onSubmit="return validate(this)">
  ...
  <div align="center">
    <table width="539" border="1">
       ...
       <tr>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Name</strong></td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Designation</strong></td>
	    <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Phone/Fax</strong></td> 
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Email</strong></td> 	  
        </tr>

              <tr>
        <td>
        <input type="text" name="name" id="name" size="33">
...
<table>
    <tr>
        ...
        <td width="150"></td>
	    <td width="630" align="center"  style="color:#69F;border-radius:10px" bgcolor="#AFD3EB" >
           <?php
            session_start();
	...
	<td width="500"></td>
       <td>
          <input class="btn" name="action" id="action" type="submit"  value="Submit Teacher/Staff"> 
	    </td>  
    </tr>
</table>

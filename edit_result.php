...
<h2 id=title>Edit Result</h2>
    <div id="maincol_container4">
      <div class="maincol_middle">
		...
		$sql=mysql_query("select * from bac.submit_result where id='$eid'");
    ...
    <table width="639" border="1">
       ...
       <tr>
        ...
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Quiz</td>
		<td align="center" style="background-color: #1D5174;"><font color="white"><strong>Attendence</td> 
		<td align="center" style="background-color: #1D5174;"><font color="white"><strong>Final Exam</font></td>  
        </tr>
       <tr>
        <td>
        <input type="text" name="student_id" id="student_id" size="24" value="<?php echo $user['student_id'];?>"/>
        <?php 
			session_start();
			if($_SESSION['msg']!="")
	...
	?>
        ...
        <td><input type="text" name="quiz" id="quiz" value="<?php echo $user['quiz'];?>"/></></td>
        <td><input type="text" name="attendence" id="attendence" value="<?php echo $user['attendence'];?>"/></></td>
        <td><input type="text" name="final_exam" id="final_exam" value="<?php echo $user['final_exam'];?>"/></></td>
       ...
       <td>
        	         <td><input class="btn" name="action" id="action" type="submit"  value="      Change & Save       "/></td>
       	           </tr>
       	         </table>
      	     </div>
          </form>                

...
function deluser(did)
{
	...
	if(msg)
	{window.location="view_lab_result.php?did="+did;}
}
</script>
</head>
<body>
...
<h2 id=title>Search Lab Result</h2>    
    <div id="maincol_container4">
      <div class="maincol_middle">
            <div class="maincol1">        
<form action="view_lab_result.php" method="post" onSubmit="return validate(this)">
...
<?php
		include('dbconnect.php');
	    $sql=mysql_query("select * from bac.submit_lab_result where student_id='$_POST[student_id]' and ays='$_POST[ays]'");
		$total=mysql_query("select online+attendence+mid_term+final_exam+assignment_project from bac.submit_lab_result where student_id='$_POST[student_id]' and ays='$_POST[ays]'");

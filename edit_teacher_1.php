...
<h2 id=title>Edit Teacher/Other Staff</h2>
    <div id="maincol_container4">
      <div class="maincol_middle">
		...
		$sql=mysql_query("select * from bac.teacher where id='$eid'");
    ...
    <table width="500" border="1">
       ...
       <tr>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Name</td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Designation</td>
	    <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Phone</td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Email</td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Type</td>		
        </tr>
       <tr>
        <td>
        <input type="text" name="name" id="name" size="22" value="<?php echo $user['name'];?>"/>
        </td>
        <td><input type="text" name="designation" id="designation" size="17" value="<?php echo $user['designation'];?>"/></td>
        <td><input type="text" name="phone" id="phone" size="17" value="<?php echo $user['phone'];?>"/></td>
		<td><input type="text" name="email" id="email" size="17" value="<?php echo $user['email'];?>"/></td>
		<td><input type="text" name="type" id="type" size="17" value="<?php echo $user['type'];?>"/></td>
       </tr>   
<tr>
<td></td>
...
<table>
    <tr>
       ...
       <td>
       <input class="btn" name="action" id="action" type="submit"  value="Save Teacher/Other Staff"> 
       </td>
    </tr> 

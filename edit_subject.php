...
if($_GET['did']){mysql_query("delete from subject where id='$_GET[did]'"); }
?>
...
function deluser(did)
{
	...
	if(msg)
	{window.location="edit_subject.php?did="+did;}
...
<h2 id=title>View & Edit Subject</h2>     
    <div id="maincol_container4">
      <div class="maincol_middle">
        <div class="maincol1">         
<form action="edit_subject.php" method="post" onSubmit="return validate(this)">
    ...
    <tr>          
                  <td>Year & Semester: </td>
                    ...
                    <option value="4.2">4th year 2nd Semester</option>
					       ...
					       <td width="100"></td>	
	   <td>
          <input class="btn" name="action" id="action" type="submit"  value="       Search Subject       ">
       </td>
					</tr>
					</table>
  </div>
		...
		echo "<td><a href=\"edit_subject_1.php?eid=".$user['id']."\">Edit</a></td>";

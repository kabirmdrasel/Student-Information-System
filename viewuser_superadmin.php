...
<h2 id=title>View User</h2>    
    <div id="maincol_container4">
      <div class="maincol_middle">
		...
		$sql=mysql_query("select * from bac.user where user_type='student'");		
		...
		echo "<th style=\"background-color:#1D5174;\">Date of Birth</th>";
		...
		echo "<td><a href=\"edit_user_1.php?eid=".$user['id']."\">Edit</a></td>";

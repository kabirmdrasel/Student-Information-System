...
<h2 id=title>Edit Alumni</h2>
    <div id="maincol_container4">
      <div class="maincol_middle">
		...
		$sql=mysql_query("select * from bac.submit_alumni where id='$eid'");
    ...
    <table width="500" border="1">
       ...
       <tr>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Student Id</td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Name Of The Candidate</td>
	    <td align="center" style="background-color: #1D5174;"><font color="white"><strong>CGPA(On the scale of 4)</td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Year</td> 		
        </tr>
       <tr>
        <td>
        <input type="text" name="student_id" id="student_id" size="22" value="<?php echo $user['student_id'];?>"/>
        </td>
        <td><input type="text" name="name" id="name" size="21" value="<?php echo $user['name'];?>"/></td>
        <td><input type="text" name="cgpa" id="cgpa" size="21" value="<?php echo $user['cgpa'];?>"/></td>
		<td><input type="text" name="year" id="year" size="21" value="<?php echo $user['year'];?>"/></td>
       </tr>   
<tr>
<td></td>
...
<table>
    <tr>
       ...
       <td>
       <input class="btn" name="action" id="action" type="submit"  value="      Save Alumni     "> 
       </td>
    </tr> 

...
<h2 id=title>Edit Exam Routine</h2>      
    <div id="maincol_container4">
      <div class="maincol_middle">
		...
		$sql=mysql_query("select * from bac.exam_info where id='$eid'");
    ...
    <table width="500" border="1">
       ...
       <tr>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Id Range</td>
        <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Room No.</td>
	    <td align="center" style="background-color: #1D5174;"><font color="white"><strong>Level</td>
       ...
       <tr>
        <td>
        <input type="text" name="id_range" id="id_range" size="22" value="<?php echo $user['id_range'];?>"/>
        </td>
        <td><input type="text" name="room" id="room" size="21" value="<?php echo $user['room'];?>"/></td>
        <td><input type="text" name="level" id="level" size="21" value="<?php echo $user['level'];?>"/></td>
        <td><input type="text" name="semester" id="semester" size="21" value="<?php echo $user['semester'];?>"/></td>
...
<table>
    <tr>
       ...
       <td>
       <input class="btn" name="action" id="action" type="submit"  value="      Save Exam Info      "> 
       </td>
    </tr> 

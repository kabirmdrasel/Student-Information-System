...
<form action="view_sstudent_result.php" method="post" onSubmit="return validate(this)">
...
<?php
		include('dbconnect.php');
	    $sql=mysql_query("select * from bac.submit_result where student_id='$username' and ays='$_POST[ays]'");
		$total=mysql_query("select quiz+attendence+final_exam from bac.submit_result where student_id='$username' and ays='$_POST[ays]'");

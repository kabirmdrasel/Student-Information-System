...
<h2 id=title>Edit User</h2>      
    <div id="maincol_container4">
      <div class="maincol_middle">
		...
		$sql=mysql_query("select * from bac.user where id='$eid'");
             ...
             <form action="action.php" method="post" >
        	   <div align="center">
        	     <table width="60%" border="0" cellpadding="3">
        	       ...
        	       <tr>
        	         <td>User Type </td>
        	         <td><input class="form" name="user_type" id="user_type" type="text" size="34" value="<?php echo $user['user_type'];?>"/></td>
       	           </tr>
        	       <tr>
        	         <td></td>
        	       ...
        	       <tr>
        	         <td>&nbsp;</td>
        	         <td><input class="btn" name="action" id="action" type="submit"  value="Save"/></td>
       	           </tr>
       	         </table>
      	     </div>
          </form>                
